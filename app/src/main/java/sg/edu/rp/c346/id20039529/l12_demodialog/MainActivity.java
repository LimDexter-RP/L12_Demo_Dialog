package sg.edu.rp.c346.id20039529.l12_demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Creation of Dialogue Builder
                AlertDialog.Builder myBuilder = new AlertDialog.Builder(MainActivity.this);

                //Setting dialogue details
...
//                myBuilder.setPositiveButton("Close", null);
        ...
        btnDemo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inflate the input.xml file (layout)
                LayoutInflater inflater =
                        (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.input, null);

                //Obtain UI components in the xml file
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    final EditText etNo1 = viewDialog.findViewById(R.id.editTextInput);
